...
// negate pixels
   ...
   public void grayscale(){
      Color[][] newImage = pix.getArray(img);
      pix.grayscale(newImage);
      pix.setImage(img,newImage);
   }

   public void sepiaTone(){
      Color[][] temp = pix.getArray(img);
      pix.sepiaTone(temp);
      pix.setImage(img,temp);
   }
   public void blur(){
      Color[][] temp = pix.getArray(img);
      Color[][] copy = pix.getArray(img);
      pix.blur(temp,copy);
      pix.setImage(img,temp);
   }
